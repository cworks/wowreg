...
public final class Input {
     ...
     */
    public Input(java.net.Socket socket) {
        try {
    ...
    public static int[] readInts(String filename) {
        return new Input(filename).readAllInts();
    }
    ...
    public static double[] readDoubles(String filename) {
        return new Input(filename).readAllDoubles();
    }
    ...
    public static String[] readStrings(String filename) {
        return new Input(filename).readAllStrings();
    }
    ...
    public static double[] readDoubles() {
        return new Input().readAllDoubles();
    }
    ...
    public static String[] readStrings() {
        return new Input().readAllStrings();
    }
}
