...
-- Created: Mon Nov  3 09:13:08 2014
-- ----------------------------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `wowreg`.`attendee` (
  ...
  `amount_paid` INT(11) NULL DEFAULT '0',
  `total_price` INT(11) NULL DEFAULT '0',
  `payment_date` DATETIME NULL DEFAULT NULL,
  `date_added` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `ATTENDEE_UNIQUE` (`event_id` ASC, `last_name` ASC, `first_name` ASC, `email` ASC))
ENGINE = InnoDB
AUTO_INCREMENT = 13
...
CREATE TABLE IF NOT EXISTS `wowreg`.`attendee_cost` (
  ...
  `event_prices_id` INT(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  INDEX `fk1_idx` (`attendee_id` ASC),
  INDEX `fk11_idx` (`event_prices_id` ASC),
  CONSTRAINT `fk1`
    ...
    ON UPDATE NO ACTION,
  CONSTRAINT `fk11`
    FOREIGN KEY (`event_prices_id`)
    REFERENCES `wowreg`.`event_prices` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
