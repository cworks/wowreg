...
INSERT INTO `wowreg`.`event_prices` (`item`, `category`, `desc`, `price`) VALUES('XS Shirt', 'merchandise', 'Xtra small Wow Conference 2015 shirt', 1000);
INSERT INTO `wowreg`.`event_prices` (`item`, `category`, `desc`, `price`) VALUES('S Shirt', 'merchandise', 'Small Wow Conference 2015 shirt', 1000);
INSERT INTO `wowreg`.`event_prices` (`item`, `category`, `desc`, `price`) VALUES('M Shirt', 'merchandise', 'Medium Wow Conference 2015 shirt', 1000);
INSERT INTO `wowreg`.`event_prices` (`item`, `category`, `desc`, `price`) VALUES('L Shirt', 'merchandise', 'Large Wow Conference 2015 shirt', 1200);
INSERT INTO `wowreg`.`event_prices` (`item`, `category`, `desc`, `price`) VALUES('XL Shirt', 'merchandise', 'Xtra Large Wow Conference 2015 shirt', 1200);
INSERT INTO `wowreg`.`event_prices` (`item`, `category`, `desc`, `price`) VALUES('XXL Shirt', 'merchandise', 'Xtra Xtra Large Wow Conference 2015 shirt', 1300);
